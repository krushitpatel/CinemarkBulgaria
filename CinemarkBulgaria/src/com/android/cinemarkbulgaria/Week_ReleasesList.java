...
public class Week_ReleasesList extends Activity implements OnClickListener{
	ListView lv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		img.setOnClickListener(new OnClickListener() {
			...
			Intent intent=new Intent(Week_ReleasesList.this,MainActivity.class);
	...
	public class Data extends AsyncTask<String, Void, ArrayList<Movies>>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			dialog=new ProgressDialog(Week_ReleasesList.this);
		...
		protected void onPostExecute(ArrayList<Movies> result) {
			...
			dialog.dismiss();
			try{
				lv.setAdapter(new setadapter(Week_ReleasesList.this,data,img1));
			}catch(Exception e){
				e.printStackTrace();
			}
		}
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
			...
			case R.id.ibsettings:
				Intent i = new Intent(Week_ReleasesList.this,About.class);
				startActivity(i);
		}
		...
		builder.setItems(items, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(items[which].equals("Nearby(GPS)")){
					...
					Intent i=new Intent(Week_ReleasesList.this,BY_GPSList.class);
					startActivity(i);
				
				}
				else if(items[which].equals("By City")){
					Intent i=new Intent(Week_ReleasesList.this,CityList.class);
					startActivity(i);
				}
			}
		});
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(items[which].equals("Week Realeses")){
					if (!isInternetPresent) {
			           ...
			           Intent i=new Intent(Week_ReleasesList.this,Week_Releasesdb.class);
			           startActivity(i);
			        }
					else{
						Intent intent=new Intent(Week_ReleasesList.this,Week_ReleasesList.class);
						startActivity(intent);
			        }
				}
					...
					if (!isInternetPresent) {
			            // Internet Connection is not present
			           Toast.makeText(getApplicationContext(), "Internet connection fail", Toast.LENGTH_LONG).show();
			           Intent i=new Intent(Week_ReleasesList.this,NowShowing_db.class);
			           startActivity(i);
			        }else{
			        	Intent intent=new Intent(Week_ReleasesList.this,NowShowingList.class);
						startActivity(intent);
			        }
				}
					...
					if (!isInternetPresent) {
			           ...
			           Toast.makeText(getApplicationContext(), "Internet connection fail", Toast.LENGTH_LONG).show();
			        	...
			        	Intent intent=new Intent(Week_ReleasesList.this,Upcoming_ReleasesList.class);
			        	startActivity(intent);
			        }
				}
					...
					if (!isInternetPresent) {
			            // Internet Connection is not present
			           Toast.makeText(getApplicationContext(), "Internet connection fail", Toast.LENGTH_LONG).show();
			           Intent i=new Intent(Week_ReleasesList.this,Top_10db.class);
			           startActivity(i);
			        }else{
			        	Intent intent=new Intent(Week_ReleasesList.this,Top10List.class);
			        	startActivity(intent);
			        }
				}
			}
