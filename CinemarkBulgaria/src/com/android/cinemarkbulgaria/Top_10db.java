...
public class Top_10db extends Activity implements OnClickListener{
	
	ArrayList<MoviesData> movies;
	Integer[] data={R.drawable.interestelar,R.drawable.draculaahistorianuncacontada, R.drawable.annabelle1,R.drawable.timmaia,R.drawable.amansaomagica,R.drawable.madeinchina,R.drawable.festanoceu3d,R.drawable.oapocalipse,R.drawable.ocandidatohonesto,R.drawable.ojuiz};
	ListView lv;
	ImageView iv;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		img.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(Top_10db.this,MainActivity.class);
        ...
        db.addContact(new MoviesData("Interestelar","Ficcao"));
      
        db.addContact(new MoviesData("Dracula","Acao"));
        
        db.addContact(new MoviesData("Annabelle","Terror"));
        db.addContact(new MoviesData("Tim Maia","Drama"));
        db.addContact(new MoviesData("A Mansao Magica","Infantil"));
       
        
        db.addContact(new MoviesData("Made In China","Comedia"));
        db.addContact(new MoviesData("Festa No Ceu","Infantil"));
        db.addContact(new MoviesData("O Apocalipse","Acao"));
        db.addContact(new MoviesData("O Candidato Honesto","Comedia"));
        db.addContact(new MoviesData("O Juiz","Drama"));
        ...
        for (MoviesData cn : movies) {
            String log = "Id: " + cn.getID()+ "Name: " + cn.getName()+ "Rev: " + cn.getGenre();
                // Writing Contacts to log
        Log.d("Name: ", log);
   
        }
        lv.setAdapter(new setadapter(Top_10db.this,movies, data));
    }
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
			...
			case R.id.ibsettings:
				Intent i = new Intent(Top_10db.this,About.class);
				startActivity(i);
		}
		...
		builder.setItems(items, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(items[which].equals("Nearby(GPS)")){
					...
					Intent i=new Intent(Top_10db.this,MainActivity.class);
					startActivity(i);
		...
		builder.setItems(items, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(items[which].equals("Week Realeses")){
					if(!isInternetPresent){
					Intent intent=new Intent(Top_10db.this,Week_Releasesdb.class);
					startActivity(intent);
					}
				}
				else if(items[which].equals("Now Showing")){
					if(!isInternetPresent){
					Intent intent=new Intent(Top_10db.this,NowShowing_db.class);
					startActivity(intent);
					}
				}
					...
					if(!isInternetPresent){
					Intent intent=new Intent(Top_10db.this,Top_10db.class);
					startActivity(intent);
					}
				}
			}
