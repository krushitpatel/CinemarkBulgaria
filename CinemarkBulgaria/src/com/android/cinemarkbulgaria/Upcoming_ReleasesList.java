...
import com.android.cinemarkbulgaria.Top10List.Data;
import com.android.cinemarkbulgaria.Top10List.setadapter;
...
public class Upcoming_ReleasesList extends Activity implements OnClickListener{
	ListView lv;
	String URL="http://www.cinemark.com.br/mobile/xml/upcoming/";
	...
	ImageView iv;
	Integer[] img1={
			R.drawable.jogosvorazesaesperancaparte1,
			R.drawable.boasorte,
			R.drawable.umalongaviagem,
			R.drawable.devoltaaojogo,
			R.drawable.elsaefred,
			R.drawable.irmadulce,
			R.drawable.setediassemfim,
			R.drawable.septimo,
			R.drawable.asaventurasdoaviaovermelho,
			R.drawable.queromatarmeuchefe2,
			R.drawable.thehobbit,
			R.drawable.omensageiro,
			R.drawable.semdireitoaresgate,
			R.drawable.operationbighero,
			R.drawable.oscarasdepau,
			R.drawable.exododeusesereis,
			R.drawable.thegreeninfirno,
			R.drawable.oduelo,
			R.drawable.aentrevista,
			R.drawable.coracoesdeferro,
			R.drawable.odestinodejupiter,
			R.drawable.kingsmanservicosecreto,
			R.drawable.velozesefuriosos7,
			R.drawable.ficiminhocas,
			R.drawable.osvingadores2};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		img.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(Upcoming_ReleasesList.this,MainActivity.class);
	...
	public class Data extends AsyncTask<String, Void, ArrayList<Movies>>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			dialog=new ProgressDialog(Upcoming_ReleasesList.this);
		...
		protected ArrayList<Movies> doInBackground(String... params) {
			...
			try {
				...
				data=Upcoming_ReleasesUtil.TheaterPullParser.parseTheaters(in);
		...
		protected void onPostExecute(ArrayList<Movies> result) {
			...
			dialog.dismiss();
			try{
		lv.setAdapter(new setadapter(Upcoming_ReleasesList.this,data,img1));
			}catch(Exception e){
				e.printStackTrace();
			}
		}
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
			...
			case R.id.ibsettings:
				Intent i = new Intent(Upcoming_ReleasesList.this,About.class);
				startActivity(i);
		}
		...
		builder.setItems(items, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(items[which].equals("Nearby(GPS)")){
					...
					Intent i=new Intent(Upcoming_ReleasesList.this,BY_GPSList.class);
					startActivity(i);
				
				}
				else if(items[which].equals("By City")){
					Intent i=new Intent(Upcoming_ReleasesList.this,CityList.class);
					startActivity(i);
				}
			}
		});
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(items[which].equals("Week Realeses")){
					if (!isInternetPresent) {
			           ...
			           Intent i=new Intent(Upcoming_ReleasesList.this,Week_Releasesdb.class);
			           startActivity(i);
			        }
					else{
						Intent intent=new Intent(Upcoming_ReleasesList.this,Week_ReleasesList.class);
						startActivity(intent);
			        }
				}
					...
					if (!isInternetPresent) {
			            // Internet Connection is not present
			           Toast.makeText(getApplicationContext(), "Internet connection fail", Toast.LENGTH_LONG).show();
			           Intent i=new Intent(Upcoming_ReleasesList.this,NowShowing_db.class);
			           startActivity(i);
			        }else{
			        	Intent intent=new Intent(Upcoming_ReleasesList.this,NowShowingList.class);
						startActivity(intent);
			        }
				}
					...
					if (!isInternetPresent) {
			            // Internet Connection is not present
			           Toast.makeText(getApplicationContext(), "Internet connection fail", Toast.LENGTH_LONG).show();
			           Intent i=new Intent(Upcoming_ReleasesList.this,Upcoming_ReleasesList.class);
			           startActivity(i);
			        }else{
			        	Intent intent=new Intent(Upcoming_ReleasesList.this,Upcoming_ReleasesList.class);
			        	startActivity(intent);
			        }
				}
					...
					if (!isInternetPresent) {
			            // Internet Connection is not present
			           Toast.makeText(getApplicationContext(), "Internet connection fail", Toast.LENGTH_LONG).show();
			           Intent i=new Intent(Upcoming_ReleasesList.this,Top_10db.class);
			           startActivity(i);
			        }else{
			        	Intent intent=new Intent(Upcoming_ReleasesList.this,Top10List.class);
			        	startActivity(intent);
			        }
				}
			}
